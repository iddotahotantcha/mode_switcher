...
J'ai réaliser cette app afin de d'essayer de mettre en place le "mode switcher".
Le "mode switcher" est en fait la fonctionnalité de nos applications qui nous permet de basculer du "dark mode" au "light mode".
